# Terms of Service for Systemize

**Last Updated: January 12, 2025**

## 1. Agreement to Terms

By downloading, installing, or using Systemize ("the app"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the app.

## 2. Description of Service

Systemize is a mobile application that provides:
- Daily schedule planning and timeline visualization
...
We grant you a limited, non-exclusive, non-transferable, revocable license to use Systemize for personal, non-commercial purposes in accordance with these Terms.

### You May:
- Use the app on your personal iOS device
- Create unlimited tasks, habits, and schedules
- Use all features for personal productivity
...
All content you create in Systemize (tasks, habits, schedules) is stored locally on your device. You retain all ownership rights to your content.

We do not:
- Access your content
- Store your content on our servers
- Have any rights to your content
...
- Device failures may result in data loss

**Recommendation:** Use iCloud or iTunes backup to protect your data.

## 8. Updates and Modifications

We reserve the right to:
- Modify or discontinue the app at any time
- Update features, change functionality
...
Systemize is a productivity tool, not a medical device or professional service.
...
Do not rely on the app for medical decisions. Consult qualified professionals for health, legal, or financial advice.
...
All intellectual property rights in the app, including:
- Software code
- Design elements
...
The app may integrate with third-party services (e.g., iOS notifications). Your use of these services is subject to their respective terms and policies.
...
Your use of the app is also subject to the Apple App Store Terms of Service. In case of conflict, Apple's terms take precedence.

---

**By using Systemize, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.**
